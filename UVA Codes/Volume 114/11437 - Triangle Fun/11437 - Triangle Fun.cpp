...
void intersect(double ax, double bx, double cx, double dx, double& x,
               double ay, double by, double cy, double dy, double& y)
{
    double del;
    double a1, b1, c1;
    double a2, b2, c2;
...
int main()
{
    ...
    while(test--)
    {
        ...
        intersect(Ax, Dx, Bx, Ex, Px,
                  Ay, Dy, By, Ey, Py);
        intersect(Ax, Dx, Cx, Fx, Rx,
                  Ay, Dy, Cy, Fy, Ry);
        intersect(Cx, Fx, Bx, Ex, Qx,
                  Cy, Fy, By, Ey, Qy);

        area = 0.5 * (Px * Qy + Qx * Ry + Rx * Py - Rx * Qy - Qx * Py - Px * Ry);
        printf("%.0lf\n", (area + 1e-7));
    }
    return 0;
}
