...
int main()
{
    ...
    while(scanf("%d", &p) == 1)
    {
        ...
        int n = (int)ceil((1.0 + sqrt(1.0 + 4.0 * (p - 1) / 3.0)) / 2.0) - 1;
        p -= 1 + 3 * n * (n - 1); // get index for current group
        ...
        //group 3: 2 * n + 1 to 3 * n
        else if(p <= 3 * n)
        {
            printf("%d %d\n", -n, 3 * n - p);
        }
        //group 4: 3 * n + 1 to 4 * n
        else if(p <= 4 * n)
        {
            printf("%d %d\n", p - 4 * n, 3 * n - p);
        }
        //group 5: 4 * n + 1 to 5 * n
        else if(p <= 5 * n)
        {
            printf("%d %d\n", p - 4 * n, -n);
        }
        //group 6: 5 * n + 1 to 6 * n
        else
        {
            printf("%d %d\n", n, p - 6 * n);
        }
