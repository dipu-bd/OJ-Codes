...
int n, m;
int arr[110][110];
int save[101][101][301];
int _save[101][101][301];
...
int recur(int x1, int y1, int x2, int y2)
{
    ...
    int& dp = save[x1][y1][(x2 << 1) + y2];
    int& dpc = _save[x1][y1][(x2 << 1) + y2];
    if(dpc == cas) return dp;

    dp = 0;
    dpc = cas;
    int cost = arr[x1][y1] + arr[x2][y2];
    if(x1 + 1 < n && x2 + 1 < n)
        dp = max(dp, cost + recur(x1 + 1, y1, x2 + 1, y2));
    if(x1 + 1 < n && y2 + 1 < m)
        dp = max(dp, cost + recur(x1 + 1, y1, x2, y2 + 1));
    if(y1 + 1 < m && x2 + 1 < n)
        dp = max(dp, cost + recur(x1, y1 + 1, x2 + 1, y2));
    if(y1 + 1 < m && y2 + 1 < m)
        dp = max(dp, cost + recur(x1, y1 + 1, x2, y2 + 1));
